...
- On the left panel, you have the add note options on the bottom. First enter your note text in the text box, choose your formatting: *bold*, *italaized*, or *Underulined*, then click *add* or *Ctrl + N* to create new.
